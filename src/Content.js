      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-20">
            <h1 className="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">React useEffect Optional Dependency Example</h1>
            <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">The card on the left runs the dummy expensive operation everytime its props are changed. The card on the right only runs the expensive operation with color as its Dependency</p>
          </div>
